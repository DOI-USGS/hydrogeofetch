...
[![CRAN status](https://www.r-pkg.org/badges/version/hydrogeofetch)](https://CRAN.R-project.org/package=hydrogeofetch) ![R-CMD-check](https://github.com/doi-usgs/nhdplusTools/workflows/R-CMD-check/badge.svg) [![codecov](https://codecov.io/gh/doi-usgs/nhdplusTools/branch/main/graph/badge.svg)](https://app.codecov.io/gh/doi-usgs/nhdplusTools)
...
For data discovery and access in a U.S. context, start with the [**Getting Started page**](https://doi-usgs.github.io/nhdplusTools/articles/hydrogeofetch.html).
